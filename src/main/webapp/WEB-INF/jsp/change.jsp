...
<script src="${pageContext.request.contextPath}/jquery-3.4.1.js">
    function f0() {
        var xmlhttp = new XMLHttpRequest();
        var type= $('input:radio[name="group2"]:checked').val();
        xmlhttp.onreadystatechange = function () {
            if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                document.getElementById("test").innerHTML = xmlhttp.responseText;
            }
        }
        xmlhttp.open("POST", "/soso_v3_war/mobileCard/change", true);
        xmlhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
        xmlhttp.send("id=$('input:radio:checked').val();");
    }
</script>
<body>

<div class="htmleaf-container">
    <form id = "1" action="/soso_v3_war/mobileCard/change">
