...
<div class="htmleaf-container">
    <form id = "1" action="/soso_v3_war/mobileCard/use">
        <fieldset tabindex="1" class='radioGroup'>
            <legend>想要做些什么:</legend>
            <input id='g1o4' name="use" value="1" type="radio">
            <label style="float: left" for='g1o4'>问候客户</label>
            <br>
            <input id='g1o5' name="use" value="2" checked type="radio">
            <label style="float: left" for='g1o5'>通知朋友手机换号</label>
            <br>
            <input id='g1o6' name="use" value="3" type="radio">
            <label style="float: left" for='g1o6'>参与环境保护实施方案问卷调查</label>
            <br>
            <input id='g1o7' name="use" value="4" type="radio">
            <label style="float: left" for='g1o7'>询问粑粑麻麻姐姐的身体状况</label>
            <br>
            <input id='g1o8' name="use" value="5" type="radio">
            <label style="float: left" for='g1o8'>把Java作业的代码发给龙哥</label>
            <br>
            <input id='g1o9' name="use" value="6" type="radio">
            <label style="float: left" for='g1o9'>在学习网站哔哩哔哩上学习</label>
        </fieldset>
    </form>
    <button class = "button" type="button" onclick="document.getElementById('1').submit();">确认</button>
