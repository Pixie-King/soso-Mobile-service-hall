...
<div style="vertical-align: center" class="htmleaf-container">
    ...
    <button class = "button bigrounded" type="button" onclick="window.location.href='${pageContext.request.contextPath}/mobileCard/towel'">开始使用</button>
    </div>
    </div>
</body>
</html>
